...
<div class="main-content p-4 w-100" style="background: #f8fafc; min-height: 100vh;">
  <div class="navbar d-flex justify-content-between align-items-center mb-4"
    ...
    <h2 class="mb-0" style="font-weight: 700; color: #2d3748;">
      <i class="bi bi-tools"></i> Data Teknisi
    </h2>
    <button class="btn btn-success btn-lg shadow-sm d-inline-flex align-items-center gap-2" style="border-radius: 8px;"
      onclick="window.location.href='<?= base_url('admin/tambah-teknisi') ?>'">
  ...
  <div class="row justify-content-center">
    <div class="col-12">
      <div class="card shadow-sm border-0" style="border-radius: 16px;">
        <div class="card-body">
          <h3 class="card-title mb-3" style="color: #2563eb;">Daftar Teknisi</h3>
            ...
            <table class="table align-middle table-bordered table-hover"
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= $t['keahlian'] ?></td>
                  <td>
                    <a href="<?= base_url('admin/edit-teknisi/' . $t['id']) ?>" class="btn btn-warning btn-sm">
                    ...
                    <button type="button"
                      ...
                      data-bs-target="#modalHapusTeknisi<?= $t['id'] ?>">
                      <i class="bi bi-trash"></i> Hapus
                    </button>

                    <!-- Modal Konfirmasi Hapus -->
                    <div class="modal fade" id="modalHapusTeknisi<?= $t['id'] ?>" tabindex="-1" aria-labelledby="modalLabel<?= $t['id'] ?>" aria-hidden="true">
                        ...
                        <div class="modal-content" style="border-radius:16px;">
                          <div class="modal-header" style="border-bottom: none; background: #f8fafc;">
                            <h5 class="modal-title" id="modalLabel<?= $t['id'] ?>">
                              <i class="bi bi-exclamation-triangle text-danger"></i> Konfirmasi Hapus Teknisi
                            </h5>
                            ...
                            <div class="card shadow-sm border-0 mx-auto" style="max-width:350px; border-radius: 12px;">
                              <div class="card-body">
                                <p class="mb-3" style="font-size:1.1rem;">
                                  Apakah Anda yakin ingin menghapus teknisi <strong><?= esc($t['nama_teknisi']) ?></strong>?
                                </p>
                                <div class="d-flex justify-content-center gap-2">
                                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                  <a href="<?= base_url('admin/hapus-teknisi/' . $t['id']) ?>" class="btn btn-danger">
                                    <i class="bi bi-trash"></i> Hapus
                                  </a>
                                </div>
                              </div>
          ...
          <div class="alert alert-info text-center mt-4" style="border-radius: 10px;">
            <i class="bi bi-info-circle"></i> Belum ada data teknisi.
          </div>
          <?php endif; ?>
        </div>
      </div>
