...
<div class="main-content p-4 w-100" style="background: #f8fafc; min-height: 100vh;">
  <div class="navbar d-flex align-items-center mb-4"
    ...
    <h2 class="mb-0" style="font-weight: 700; color: #2d3748;">
      <i class="bi bi-clock-history"></i> Riwayat Pemesanan - Admin
    </h2>
  </div>
  <div class="row justify-content-center">
    <div class="col-12">
      <div class="card shadow-sm border-0" style="border-radius: 16px;">
        <div class="card-body">
          <h3 class="card-title mb-3" style="color: #2563eb;">Riwayat Servis</h3>
            ...
            <table class="table align-middle table-bordered table-hover"
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?= site_url('admin/ubah-riwayat/' . $row->id) ?>" class="btn btn-warning btn-sm">
                      <i class="bi bi-pencil-square"></i> Ubah
                    </a>
                    <a href="<?= site_url('admin/hapus-riwayat/' . $row->id) ?>" class="btn btn-danger btn-sm"
                      onclick="return confirm('Yakin ingin menghapus riwayat ini?')">
                      <i class="bi bi-trash"></i> Hapus
                    </a>
                    <a href="<?= site_url('admin/invoice/' . $row->pemesanan_id) ?>" class="btn btn-info btn-sm">
          ...
          <div class="alert alert-info text-center mt-4" style="border-radius: 10px;">
            <i class="bi bi-info-circle"></i> Belum ada riwayat servis.
          </div>
          <?php endif; ?>
        </div>
      </div>
