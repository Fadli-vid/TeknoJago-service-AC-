            ...
            <div class="col-12">
                <div class="login-card">
                    <div class="text-center">
                        <span class="login-icon"><i class="bi bi-tools"></i></span>
                        <h3 class="login-title mb-2">Login Teknisi</h3>
                        <div class="mb-3 text-muted" style="font-size: 1.05rem;">Akses Panel Teknisi Tekno Jago</div>
                    </div>
                    ...
                    <?php endif; ?>
                    <form action="<?= base_url('/teknisi/login/proses') ?>" method="post">
                        <div class="mb-3">
